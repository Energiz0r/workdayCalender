...
namespace WorkdayCalender2.Tests
{
    [TestClass]
    public class WorkdayCalenderTests
    {
        ...
        [TestMethod, TestCategory("2. TDD - Tickbased")]
        ...
        [TestMethod, TestCategory("2. Acceptance - Tickbased"), Ignore()]
        ...
        [TestMethod, TestCategory("2. Acceptance - Tickbased")]
        public void CaseOne()
        {
